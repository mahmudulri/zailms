...
class PriceHelper extends StatelessWidget {
  PriceHelper({
    super.key,
            ...
            ? currencyController.myCurrency.value.data!["currency_placement"] ==
                ...
                ? Text(
                    currencyController.myCurrency.value.data!["symbol"] +
                        double.parse(discountPrice.toString())
                            .toStringAsFixed(2),
                    style: GoogleFonts.jost(
                      color: AppColors.scaffoldColor,
                      fontWeight: FontWeight.w500,
                      fontSize: screenWidth * 0.0250,
                    ),
                  )
                : Text(
                    double.parse(discountPrice.toString()).toStringAsFixed(2) +
                        currencyController.myCurrency.value.data!["symbol"],
                    style: GoogleFonts.jost(
                      color: AppColors.scaffoldColor,
                      fontWeight: FontWeight.w500,
