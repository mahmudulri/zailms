      ...
      () => liveclassController.isLoading.value == false
          ? ListView.separated(
              ...
              itemCount: liveclassController
                  .allmylearningdata.value.data!.pastLiveClasses.length,
              itemBuilder: (context, index) {
                final data = liveclassController
                    .allmylearningdata.value.data!.pastLiveClasses[index];
                return Container(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(data.duration.toString() + " mins"),
                          ],
                        ),
                        SizedBox(
                          height: 8,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(data.classTopic.toString()),
                            ),
                          ],
                        ),
                        SizedBox(
                        ...
                        Row(
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Text(
                                data.joinUrl.toString().substring(0, 20),
                                style: GoogleFonts.jost(
                                  fontWeight: FontWeight.w400,
