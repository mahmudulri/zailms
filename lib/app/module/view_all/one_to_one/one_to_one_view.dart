...
import 'package:lmszai/app/module/userprofile/profile_controller.dart';
import 'package:badges/badges.dart' as badges;

import '../../../const/color.dart';
import '../../forum/forum.dart';
import 'one_to_one_controller.dart';

class OneToOneAllView extends StatelessWidget {
  OneToOneAllView({super.key});

  ProfileController profileController = Get.put(ProfileController());

  CurrencyController currencyController = Get.put(CurrencyController());
  OnetoOneAllController onetoOneAllController =
      Get.put(OnetoOneAllController());
        ...
        () => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: onetoOneAllController.isLoading.value == false
                    ? ListView.separated(
                        separatorBuilder: (context, index) {
                          return SizedBox(
                            height: 5,
                        ...
                        itemCount: onetoOneAllController
                            .allcourses.value.data!.instructors!.length,
                        itemBuilder: (context, index) {
                          final data = onetoOneAllController
                              .allcourses.value.data!.instructors![index];
