...
import 'board_all_controller.dart';

class ViewAllCourse extends StatefulWidget {
  ViewAllCourse({super.key});
...
class _ViewAllCourseState extends State<ViewAllCourse> {
  ...
  BoardAllController boardAllController = Get.put(BoardAllController());
        ...
        () => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: boardAllController.isLoading.value == false
                    ? ListView.separated(
                        separatorBuilder: (context, index) {
                          return SizedBox(
                            height: 5,
                        ...
                        itemCount: boardAllController
                            .allcourses.value.data!.courses!.length,
                        itemBuilder: (context, index) {
                          final data = boardAllController
