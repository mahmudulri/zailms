...
//
//     final tescorseModel = tescorseModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

TescorseModel tescorseModelFromJson(String str) =>
    TescorseModel.fromJson(json.decode(str));

String tescorseModelToJson(TescorseModel data) => json.encode(data.toJson());
...
class TescorseModel {
  ...
  factory TescorseModel.fromJson(Map<String, dynamic> json) => TescorseModel(
